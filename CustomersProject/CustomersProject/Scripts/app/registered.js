$(document).ready(function () {
    ...
    $.ajax({
        ...
        url: 'https://www.ieianchorpensions.com/api/api_customers_registered',
    ...
    $(".pagination").on("click", ".p-link", function (e) {
        ...
        var $url = "https://www.ieianchorpensions.com/api/api_customers_registered" + $pageUrl;
        $.ajax({
            method: 'GET',
            url: $url,
            headers: {
